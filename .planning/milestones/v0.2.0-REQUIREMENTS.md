# Requirements Archive: v0.2.0 Publishing Workflow
...
- [ ] **HOOK-04**: Maintenance hook runs health checks on `claude --maintenance` (deferred to v0.3.0+)
...
**Shipped:** 26 of 27 v0.2.0 requirements
**Adjusted:** None
**Dropped:** None
**Deferred:** HOOK-04 (maintenance hook) — not in original success criteria, moved to v0.3.0+

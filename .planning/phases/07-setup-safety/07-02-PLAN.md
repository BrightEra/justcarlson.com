...
# Note: HOOK-04 (Maintenance hook) is assigned to Phase 7 in REQUIREMENTS.md but is NOT
# included in Phase 7's success criteria in ROADMAP.md. The success criteria focus on:
# setup, config storage, config reading pattern, init hook, and git safety.
# HOOK-04 is deferred - will be addressed when maintenance workflows are designed.
# See: ROADMAP.md Phase 7 Success Criteria (5 items, none mention maintenance)
